...
MODEL_AUDITOR = os.getenv("MODEL_AUDITOR", "claude-opus-4-8")                # fallback 2nd-model check on spend
# --- Cross-vendor auditor (Gemini) — truly independent review of spend actions ---
